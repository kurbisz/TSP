...
def draw():
    ...
    plt.bar(r1 - 3 * l, kr, color='lime', width=l, label='K-Random dla k = 100')
    plt.bar(r1 - 2 * l, kr2, color='darkgreen', width=l, label='K-Random dla k = 2*n')
    ...
    plt.bar(r1 + 1 * l, best, color='green', width=l, label='Best solution')
    plt.xticks([r + l for r in range(10)], names)
    plt.legend()
